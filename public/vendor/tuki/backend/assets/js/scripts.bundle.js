...
KTUtil.ready(function() {
    ...
    if (typeof KTLayoutAsideMenu !== 'undefined') {
        ...
        KTLayoutAsideMenu.init('kt_aside_menu0');
        KTLayoutAsideMenu.init('kt_aside_menu1');
        KTLayoutAsideMenu.init('kt_aside_menu2');
        KTLayoutAsideMenu.init('kt_aside_menu3');
        KTLayoutAsideMenu.init('kt_aside_menu4');
    }
