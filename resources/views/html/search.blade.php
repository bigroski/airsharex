                              ...
                              <div class="booking-sidebar">
                                        ...
                                        <div class="col-lg-12 col-md-4 col-sm-6 col-12 pt-2">
                                             ...
                                             <select name="nationality" class="test_skill form-control "
                                                  ...
                                                  @foreach ($nationalities as $nationality)
                                                                   <option value="{{ $nationality['NationalityCode'] }}">
                                        ...
                                        <div class="col-lg-12 col-md-4 col-sm-6 col-12">
                                             ...
                                             <select name="heliServiceType" class="test_skill form-control "
                                                  ...
                                                  @foreach ($heliServiceTypes as $heliServicdType)
                                                                   <option value="{{ $heliServicdType['ServiceTypeId'] }}">
                                   ...
                                   <div class="booking-item">
                                        ...
                                        <div class="flight-class">
                                             <div class="form-check">
                                                  <input class="form-check-input" name="flight-class" type="checkbox"
                                                       value="1" id="flight-class1">
                                                  <label class="form-check-label" for="flight-class1"> Business
                                                       <span>(20)</span>
                                                  </label>
                                             </div>
                                             <div class="form-check">
                                                  <input class="form-check-input" name="flight-class" type="checkbox"
                                                       value="2" id="flight-class2">
                                                  <label class="form-check-label" for="flight-class2"> First Class
                                                       <span>(15)</span>
                                                  </label>
                                             </div>
                                             <div class="form-check">
                                                  <input class="form-check-input" name="flight-class" type="checkbox"
                                                       value="3" id="flight-class3">
                                                  <label class="form-check-label" for="flight-class3"> Economy
                                                       <span>(18)</span>
                                                  </label>
                                             </div>
                                        </div>
                                   ...
                                   <div class="booking-item">
                                        ...
                                        <div class="flight-weight">
                                             <div class="form-check">
                                                  <input class="form-check-input" name="flight-weight" type="checkbox"
                                                       value="1" id="flight-weight1">
                                                  <label class="form-check-label" for="flight-weight1"> 25 Kg
                                                       <span>(20)</span>
                                                  </label>
                                             </div>
                                        </div>
                                   ...
                                   <div class="booking-item">
                                        ...
                                        <div class="flight-refundable">
                                             <div class="form-check">
                                                  <input class="form-check-input" name="flight-refundable"
                                                       type="checkbox" value="1" id="flight-refundable1">
                                                  <label class="form-check-label" for="flight-refundable1"> Non
                                                       Refundable <span>(20)</span>
                                                  </label>
                                             </div>
                                             <div class="form-check">
                                                  <input class="form-check-input" name="flight-refundable"
                                                       type="checkbox" value="2" id="flight-refundable2">
                                                  <label class="form-check-label" for="flight-refundable2"> Refundable
                                                       <span>(15)</span>
                                                  </label>
                                             </div>
                                             <div class="form-check">
                                                  <input class="form-check-input" name="flight-refundable"
                                                       type="checkbox" value="3" id="flight-refundable3">
                                                  <label class="form-check-label" for="flight-refundable3"> As Per Rules
                                                       <span>(18)</span>
                                                  </label>
                                             </div>
                                        </div>
                                                                   ...
                                                                   <div class="flight-booking-info">
                                                                         <div class="flight-booking-content">
                                                                                ...
                                                                                <div class="flight-booking-duration">
                                                                                      <span class="duration-text">{{$data['ExpectedTravelDuration']}}
                                                                                            h</span>
                                                                                </div>
                                                                         </div>
                                                                   </div>
                                                                                ...
                                                                                <div class="row">
                                                                                      <div class="col-lg-12 col-xl-6">
                                                                                            <div class="flight-booking-detail-left">
                                                                                                  <ul class="nav nav-tabs" id="flTab1"
                                                                                                         role="tablist">
                                                                                                         <li class="nav-item"
                                                                                                               role="presentation">
                                                                                                               <button class="nav-link active"
                                                                                                                     id="fl-tab1"
                                                                                                                     data-bs-toggle="tab"
                                                                                                                     data-bs-target="#fl-tab-pane1"
                                                                                                                     type="button" role="tab"
                                                                                                                     aria-controls="fl-tab-pane1"
                                                                                                                     aria-selected="true">{{ $data['DepartureCity']}}
                                                                                                                     -
                                                                                                                     {{ $data['ArrivalCity']}}</button>
                                                                                                         </li>
                                                                                                  </ul>
                                                                                                  <div class="tab-content" id="flTabContent1">
                                                                                                         <div class="tab-pane fade show active"
                                                                                                               id="fl-tab-pane1" role="tabpanel"
                                                                                                               aria-labelledby="fl-tab1"
                                                                                                               tabindex="0">
                                                                                                               <div
                                                                                                                     class="flight-booking-detail-info">
                                                                                                                     <div
                                                                                                                           class="flight-booking-airline">
                                                                                                                           <div
                                                                                                                                  class="flight-airline-img">
                                                                                                                                  <img src="{{$data['OperatorLogo'] }}"
                                                                                                                                        alt>
                                                                                                                           </div>
                                                                                                                           <div
                                                                                                                                  class="flight-airline-info flex-grow-1">
                                                                                                                                  <h5
                                                                                                                                        class="flight-airline-name">
                                                                                                                                        {{$data['OperatorName']}}
                                                                                                                                  </h5>
                                                                                                                                  <span
                                                                                                                                        class="flight-airline-model">SG
                                                                                                                                        143 |
                                                                                                                                        AT7</span>
                                                                                                                           </div>
                                                                                                                           <p
                                                                                                                                  class="flight-airline-class">
                                                                                                                                  ( Economy )</p>
                                                                                                                     </div>
                                                                                                                     <div
                                                                                                                           class="flight-booking-time">
                                                                                                                           <div class="start-time">
                                                                                                                                  <div
                                                                                                                                        class="start-time-icon">
                                                                                                                                        <i
                                                                                                                                              class="fal fa-plane-departure"></i>
                                                                                                                                  </div>
                                                                                                                                  <div
                                                                                                                                        class="start-time-info">
                                                                                                                                        <h6
                                                                                                                                              class="start-time-text">
                                                                                                                                              {{$data['DepartureTime']}}
                                                                                                                                        </h6>
                                                                                                                                        <p
                                                                                                                                              class="flight-full-date">
                                                                                                                                              {{$data['TripDate']}}
                                                                                                                                        </p>
                                                                                                                                        <span
                                                                                                                                              class="flight-destination">{{ $data['DepartureCity']}}</span>
                                                                                                                           ...
                                                                                                                           <div class="flight-stop">
                                                                                                                                  <span
                                                                                                                                        class="flight-stop-number">Non
                                                                                                                                        Stop</span>
                                                                                                                                  <div
                                                                                                                                        class="flight-stop-arrow">
                                                                                                                                  </div>
                                                                                                                                  <div
                                                                                                                                        class="flight-booking-duration">
                                                                                                                                        <span
                                                                                                                                              class="duration-text">{{$data['ExpectedTravelDuration']}}
                                                                                                                                              h</span>
                                                                                                                                  </div>
                                                                                                                           </div>
                                                                                                                           <div class="end-time">
