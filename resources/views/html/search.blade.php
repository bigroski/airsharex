                                                                      ...
                                                                      <div class="flight-booking-detail-left">
                                                                           <ul class="nav nav-tabs" id="flTab1" role="tablist">
                                                                                <li class="nav-item" role="presentation">
                                                                                     <button class="nav-link active" id="fl-tab1" data-bs-toggle="tab" data-bs-target="#fl-tab-pane1" type="button" role="tab" aria-controls="fl-tab-pane1" aria-selected="true">{{ $data['DepartureCity']}}
                                                                                          -
                                                                                     ...
                                                                                     <div class="flight-booking-detail-info">
                                                                                          <div class="flight-booking-airline">
                                                                                               ...
                                                                                               <div class="flight-airline-info flex-grow-1">
                                                                                                    ...
                                                                                                    <span class="flight-airline-model">SG
                                                                                                         143 |
                                                                                                         AT7</span>
                                                                                               </div>
                                                                                               <p class="flight-airline-class">
                                                                                                    ( Economy )</p>
                                                                                          </div>
                                                                                          <div class="flight-booking-time">
                                                                                               <div class="start-time">
                                                                                               ...
                                                                                               <div class="flight-stop">
                                                                                                    <span class="flight-stop-number">Non
                                                                                                         Stop</span>
                                                                                                    <div class="flight-stop-arrow">
                                                                                                    </div>
                                                                                                    <div class="flight-booking-duration">
                                                                                                         <span class="duration-text">{{$data['ExpectedTravelDuration']}}
                                                                                                              h</span>
                                                                      ...
                                                                      <div class="flight-booking-detail-right">
                                                                           ...
                                                                           <div class="flight-booking-detail-price-outer">
                                                                                <form name="flight-book-form" id="filghtBookForm" action="/checkout" method="get">
                                                                                     ...
                                                                                     <input type="hidden" name="TxnRefId" id="TxnRefId" value={{$TransactionRefId}}>
                                                                                     <input type="hidden" name="TxnRefId" id="TxnRefId" value={{$TransactionRefId}}>
                                                                                     <input type="hidden" name="masterSerarchId" id="masterSerarchId" value={{$searchMasterId}}>
                                                                                     ...
                                                                                     <div class="flight-booking-detail-price">
                                                                                          <div class="book-btn">
                                                                                               ...
                                                                                               <h6 class="flight-booking-detail-price-title">
                                                                                                    Total ({{$seatCount}}
                                                                                                    Traveler)</h6>
                                                                                          </div>
                                                                                          <button class="btn btn-danger" onclick="redirectToCheckout($data['SearchMasterId'])" value="Book Now">Book
                                                                                               Now</button>
                                                                                     </div>
