...
class HelecoptorSearch extends Component

{
    use TukiComponents;
    public $componentName = 'Main Helecoptor Search';
    ...
    {
        return view('components.page-blocks.helecoptor-search')->with($this->getValues());
    }
